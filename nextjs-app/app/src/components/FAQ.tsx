...
const faqData: FAQItem[] = [
  ...
  {
    question: "How is this like a bank's safety deposit box?",
    answer: "Think of Lockbox as a digital safety deposit box - but instead of storing valuables in a bank vault, you're storing small amounts of encrypted data on the Solana blockchain. Just like a safety deposit box requires your physical key to open, Lockbox requires your wallet signature to decrypt. The bank (blockchain) securely holds the box, but only you have the key to unlock and view what's inside. ⚠️ This is a demo for educational purposes - do not store real sensitive data without a security audit."
  },
  {
  ...
  },
  {
    ...
    answer: "You can store up to 1 KiB (1024 bytes) of data per transaction. This is suitable for testing with sample text or non-sensitive notes. ⚠️ Do NOT store real passwords, private keys, or sensitive data in this demo version."
  },
  {
  ...
  },
  {
    ...
    answer: "NO. Lockbox is a demonstration project on Solana Devnet for educational and testing purposes only. It has NOT undergone professional security audits and should NOT be used for production. Never store real sensitive data. Devnet can be reset at any time, and this code is not production-ready."
  },
  {
  ...
  },
  {
    ...
    answer: "⚠️ DEMO ONLY: This version is for testing and education. Store only test data or non-sensitive notes (up to 1024 bytes). DO NOT store real passwords, private keys, seed phrases, 2FA codes, or any critical data. This implementation has not been professionally audited for production use."
  },
  {
  ...
  },
  {
    ...
    answer: "Lockbox was created by GRAFFITO, a cybersecurity consultant and NFT artist who enjoys prototyping for fun. This project combines security best practices with blockchain technology to explore new ways of protecting sensitive data."
  }
];
